...
public class Parallax : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        viewWidth = layers[0].GetComponent<SpriteRenderer>().bounds.size.x;
    }
    ...
    void Update()
    {
        ...
        if (layers[0].position.x + viewWidth < Camera.main.transform.position.x - viewWidth / 2)
        {
            // Le déplacer au dessus de l’autre sprite
            layers[0].position += Vector3.left * viewWidth * 2;
